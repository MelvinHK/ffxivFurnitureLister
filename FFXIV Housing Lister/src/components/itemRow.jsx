      ...
      <td className="pad-small">
        {item.materials == "N/A" ? item.materials :
          showMaterials ?
            <div className="flex gap">
              <div>
                {item.materials.map((material) => {
                  return (<>
                    <p key={item.id + material.name} className="text-small">
              ...
              <button onClick={() => setShowMaterials(false)} className="icon-btn text-small pad-0">
            ...
            <button onClick={() => setShowMaterials(true)} className="icon-btn text-small pad-0">
